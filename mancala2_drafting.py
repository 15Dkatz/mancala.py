...
if __name__ == '__main__':
	...
	# - add stones per pit for sys.argv[4] an integer determing either 2, 3, or 4 stones per pit
	# - add computer or human control
	# - if sys.argv[2] or sys.argv[3] == computer, run the computer function.
	
# 1. need to implement 'capturing', when if you land in an empty space, you take add all the stones of your opponent in the 
#    subsequent pit to your store
# 2. Need to create the A.I. in a separate file titled. katz.py
# 3. The initial A.I. must simply compare pit vs. pit, return who's winning, and make the appropriate move if the computer is player 1 or if the computer is player 2


#THE AI MUST PREVENT CAPTURING, run the game, but also check if opponent has empty stores and thwart such
#check for a series of moves that can set up a capture, and if a capture is possible, DO IT!

#make sure to check if player is choosing a 0 spot!